# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 20:54:55 2019
...
def ddpg(
  ...
  for i_episode in range(num_train_episodes):
    ...
    print("Episode:", i_episode + 1, "Rewards:", episode_return, 'episode_length:', episode_length)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--num_train_episodes', type=int, default=3000)
  parser.add_argument('--save_folder', type=str, default='ddpg_monitor2')
